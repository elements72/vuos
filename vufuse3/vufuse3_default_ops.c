...
static int vustd_getattr (const char *path, struct stat *stat, struct fuse_file_info *fi)
{
	...
	printkdebug(Z,"DEFAULT getattr %s\n", path);
	return -ENOTSUP;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT readlink %s\n", path);
	return -EINVAL;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT unlink %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT symlink %s\n", path);
	return -ENOSYS;
}
...
static int vustd_rename (const char *path, const char *newpath, unsigned int flags)
{
	...
	printkdebug(Z,"DEFAULT rename %s\n", path);
	return -ENOSYS;
}
...
{
    /*Added struct fuse_file_info *fi*/
	printkdebug(Z,"DEFAULT truncat %s\n", path);
	return -ENOSYS;
}
...
#endif
{
	printkdebug(Z,"DEFAULT statfs %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT setxattr %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT getxattr %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT listxattr %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT removexattr %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT opendir %s\n", path);
	return 0;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT fsyncdir %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT access %s\n", path);
	return -ENOSYS;
}
...
{
    /* unchanged */
	printkdebug(Z,"DEFAULT create %s\n", path);
	return -ENOSYS;
}
...
{
    /* Added struct fuse_file_info *fi */
    printkdebug(Z,"DEFAULT utimens %s\n", path);
    return -ENOSYS;
}
